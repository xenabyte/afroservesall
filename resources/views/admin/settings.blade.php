                        ...
                        <table id="fixed-header" class="table table-borderedless dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $hairActiveHour->year }} </td>
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete{{$hairActiveHour->id}}" class="link-danger"><i class="ri-delete-bin-5-line"></i></a>
                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit{{$hairActiveHour->id}}" class="link-primary"><i class="ri-edit-circle-fill"></i></a>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <h4 class="mb-3 mt-4">Are you sure you want to delete <br/> {{ $hairActiveHour->year }}?</h4>
                                                                <form action="{{ url('/admin/deleteSession') }}" method="POST">
                                                                    @csrf
                                                                    <input name="session_id" type="hidden" value="{{$hairActiveHour->id}}">
                                                                    <hr>
                                                    ...
                                                    <div class="modal-content border-0 overflow-hidden">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('/admin/updateSession') }}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <input name="level_id" type="hidden" value="{{$hairActiveHour->id}}">
                                
                                                                <div class="mb-3">
                                                                    <label for="year" class="form-label">Session</label>
                                                                    <input type="text" class="form-control" name="year"  minlength="9" maxlength="9" id="year" value="{{ $hairActiveHour->year }}">
                                                                </div>
                    ...
                    <div class="col-sm-6 col-xl-6">
                        ...
                        <table id="fixed-header" class="table table-borderedless dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">{{ $loop->iteration }}</th>
                                    <td>{{ $foodActiveHour->year }} </td>
                                    <td>
                                        <div class="hstack gap-3 fs-15">
                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete{{$foodActiveHour->id}}" class="link-danger"><i class="ri-delete-bin-5-line"></i></a>
                                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit{{$foodActiveHour->id}}" class="link-primary"><i class="ri-edit-circle-fill"></i></a>
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-body text-center p-5">
                                                            ...
                                                            <div class="mt-2">
                                                                ...
                                                                <h4 class="mb-3 mt-4">Are you sure you want to delete <br/> {{ $foodActiveHour->year }}?</h4>
                                                                <form action="{{ url('/admin/deleteSession') }}" method="POST">
                                                                    @csrf
                                                                    <input name="session_id" type="hidden" value="{{$foodActiveHour->id}}">
                                                                    <hr>
                                                                    <button type="submit" id="submit-button" class="btn btn-danger w-100">Yes, Delete</button>
                                                                </form>
                                                            </div>
                                                    ...
                                                    <div class="modal-content border-0 overflow-hidden">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ url('/admin/updateSession') }}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <input name="level_id" type="hidden" value="{{$foodActiveHour->id}}">
                                
                                                                <div class="mb-3">
                                                                    <label for="year" class="form-label">Session</label>
                                                                    <input type="text" class="form-control" name="year"  minlength="9" maxlength="9" id="year" value="{{ $foodActiveHour->year }}">
                                                                </div>

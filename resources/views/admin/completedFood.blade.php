...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Completed Food Orders</h4>

            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item active">Completed Food Orders</li>
                </ol>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="card-title">Completed Food Orders</h4>
                <hr>
                ...
                <table id="datatable" class="table table-bfoodOrdered dt-responsive  nowrap w-100">
                    ...
                    <tr>
                        ...
                        <td class="bg-primary-subtle">{{ $foodOrder->sku }}</td>
                        ...
                        <td>
                            ...
                            @elseif($foodOrder->status == 'completed')
                        ...
                        <td>
                            <a class="btn btn-outline-secondary btn-sm edit" data-bs-toggle="modal" data-bs-target="#viewOrder{{ $foodOrder->id }}" title="view">
                                <i class="fas fa-eye"></i>
                            </a>

                            <!-- Static Backdrop Modal -->
                            <div class="modal fade" id="viewOrder{{ $foodOrder->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table align-middle mb-0 table-nowrap">
                                                                ...
                                                                <tbody>
                                                                    @foreach($foodOrder->cartItems as $cartItem)
                                                                    <tr class="product">
                            ...
                            <a class="btn btn-outline-primary btn-sm edit" data-bs-toggle="modal" data-bs-target="#updateOrder{{ $foodOrder->id }}" title="Edit">
                                <i class="fas fa-pencil-alt"></i>
                            </a>

                            <!-- Static Backdrop Modal -->
                            <div class="modal fade" id="updateOrder{{ $foodOrder->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form method="POST" action="{{ url('/admin/updateOrder') }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="order_id" value="{{ $foodOrder->id }}">

                                                <div class="mb-3 form-floating">
                                                    <select class="form-select" name="status">
                                                        <option @if($foodOrder->status == 'pending') selected @endif value="pending">Pending</option>
                                                        <option @if($foodOrder->status == 'delivery ongoing') selected @endif value="delivery ongoing">Delivery Ongoing</option>
                                                        <option @if($foodOrder->status == 'completed') selected @endif value="completed">Completed</option>
                                                    </select> 
